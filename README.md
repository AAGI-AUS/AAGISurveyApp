...
This does not replace [{AAGISurvey}](https://aagi-aus.github.io/AAGISurvey/), but simply provides another user-friendly interface to it for creating survey URLs.
...
Start R, it doesn't matter if it's RStudio, Positron, Nvim-R, an R console, VSCode, etc. but it should be a local session on your own computer.
Once you've started R, load the library and launch the app.
